...
describe('Students', () => {
  ...
  it('shows students added in the database', () => {
    return cy.fixture('student/testRendering.json')
      .then(fixture => {
  ...
  it('filters by name, cpf or email', () => {
    return cy.fixture('student/testFiltering.json')
      .then(fixture => {
        cy.seedTable<Student>({
          tableName: 'student',
          data: fixture,
  ...
  it('paginates results', () => {
    return cy.fixture('student/testPagination.json')
      .then(fixture => {
        cy.seedTable<Student>({
          tableName: 'student',
          data: fixture,
